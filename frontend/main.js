...
var author$project$Z3$Display = F4(
	function (globalParams, globalParamDescs, statistics, warnings) {
		return {globalParamDescs: globalParamDescs, globalParams: globalParams, statistics: statistics, warnings: warnings};
	});
var author$project$Z3$Limit = F3(
	function (timeout, softTimeout, memory) {
		return {memory: memory, softTimeout: softTimeout, timeout: timeout};
	});
var author$project$Z3$Params = F5(
	function (format, display, limit, globalParams, moduleParams) {
		return {display: display, format: format, globalParams: globalParams, limit: limit, moduleParams: moduleParams};
	});
var author$project$Z3$Smtlib2 = {$: 'Smtlib2'};
...
var author$project$Z3$default = A5(
	author$project$Z3$Params,
	author$project$Z3$Smtlib2,
	A4(author$project$Z3$Display, false, false, false, false),
	A3(author$project$Z3$Limit, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing),
...
var author$project$Cvc4$createJson = function (params) {
	...
	return elm$json$Json$Encode$string(
		function () {
			switch (format.$) {
				...
				case 'Dimacs':
					return 'DIMACS';
				case 'WeightedCnfDimacs':
					return 'Weighted CNF DIMACS';
				case 'PbOptimization':
					return 'PB optimization';
				case 'CplexLp':
					return 'CPLEX LP';
				default:
					return 'Z3 log';
				...
				elm$json$Json$Encode$object(
					_List_fromArray(
						[
							_Utils_Tuple2(
							'format',
							author$project$Z3$jsonOfFormat(params.format)),
							_Utils_Tuple2(
							'display',
							elm$json$Json$Encode$object(
								_List_fromArray(
									[
										_Utils_Tuple2(
										'global_parameters',
										elm$json$Json$Encode$bool(params.display.globalParams)),
										_Utils_Tuple2(
										'global_parameter_descriptions',
										elm$json$Json$Encode$bool(params.display.globalParamDescs)),
										_Utils_Tuple2(
										'statistics',
										elm$json$Json$Encode$bool(params.display.statistics)),
										_Utils_Tuple2(
										'warnings',
										elm$json$Json$Encode$bool(params.display.warnings))
									]))),
							_Utils_Tuple2(
							'limit',
...
var author$project$Main$createVerificationRequestBody = function (model) {
		...
		elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'src',
					elm$json$Json$Encode$string(model.input)),
					_Utils_Tuple2(
					'argments',
					function () {
						var _n0 = model.params;
						if (_n0.$ === 'Z3') {
							var z3params = _n0.a;
							return author$project$Z3$createJson(z3params);
						} else {
							var cvc4params = _n0.a;
							return author$project$Cvc4$createJson(cvc4params);
						}
					}())
				])));
};
...
var author$project$Main$resultDecoder = A2(elm$json$Json$Decode$field, 'stdout', elm$json$Json$Decode$string);
...
var author$project$Main$getVerificationResult = function (model) {
	return elm$http$Http$post(
		{
			body: author$project$Main$createVerificationRequestBody(model),
...
var author$project$Util$toString = function (err) {
	switch (err.$) {
		case 'Timeout':
			return 'Timeout';
		case 'NetworkError':
		...
		case 'BadStatus':
			var resp = err.a;
			return 'BadStatus ' + elm$core$String$fromInt(resp);
		case 'BadUrl':
			var url = err.a;
			return 'BadUrl: ' + url;
		default:
		...
		switch (msg.$) {
			case 'Format':
				...
				return _Utils_update(
					params,
					{format: format});
			case 'DisplayGlobalParams':
				var oldDisplay = params.display;
				var globalParams = !params.display.globalParams;
				...
				return _Utils_update(
					params,
					{display: display});
			case 'DisplayGlobalParamDescs':
				var oldDisplay = params.display;
				var globalParamDescs = !params.display.globalParamDescs;
				var display = _Utils_update(
					oldDisplay,
					{globalParamDescs: globalParamDescs});
				return _Utils_update(
					params,
					{display: display});
			case 'DisplayStatistics':
				var statistics = !params.display.statistics;
				var oldDisplay = params.display;
				var display = _Utils_update(
					oldDisplay,
			...
			case 'DisplayWarnings':
				var warnings = !params.display.warnings;
				var oldDisplay = params.display;
				var display = _Utils_update(
					oldDisplay,
					{warnings: warnings});
			...
			case 'Timeout':
				var n = msg.a;
				var oldLimit = params.limit;
				var limit = _Utils_update(
					oldLimit,
					{
						timeout: elm$core$Maybe$Just(n)
					});
				return _Utils_update(
					params,
					{limit: limit});
			case 'SoftTimeout':
				...
				var limit = _Utils_update(
					oldLimit,
					{
						softTimeout: elm$core$Maybe$Just(n)
					});
				return _Utils_update(
					params,
					{limit: limit});
...
var author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					case 'z3':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									params: author$project$Main$Z3(author$project$Z3$default)
								}),
							elm$core$Platform$Cmd$none);
					case 'cvc4':
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									params: author$project$Main$Cvc4(author$project$Cvc4$default)
								}),
							elm$core$Platform$Cmd$none);
					default:
						return author$project$Util$undefined(_Utils_Tuple0);
				...
				if (_n2.$ === 'Z3') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								params: author$project$Main$Z3(
									A2(author$project$Z3$update, z3msg, z3params))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return author$project$Util$undefined(_Utils_Tuple0);
			...
			case 'Cvc4Msg':
				var cvc4msg = msg.a;
				var _n3 = model.params;
				if (_n3.$ === 'Cvc4') {
					var cvc4params = _n3.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								params: author$project$Main$Cvc4(
									A2(author$project$Cvc4$update, cvc4msg, cvc4params))
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return author$project$Util$undefined(_Utils_Tuple0);
...
var author$project$Main$Verify = {$: 'Verify'};
...
var author$project$Main$Z3Msg = function (a) {
	return {$: 'Z3Msg', a: a};
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Attributes$class('form-icon')
						]),
					_List_Nil),
...
var author$project$Z3$DisplayStatistics = {$: 'DisplayStatistics'};
var author$project$Z3$DisplayWarnings = {$: 'DisplayWarnings'};
var author$project$Z3$Format = function (a) {
	return {$: 'Format', a: a};
};
var author$project$Z3$formatOfString = function (str) {
	if (str === 'smtlib2') {
		return author$project$Z3$Format(author$project$Z3$Smtlib2);
	} else {
		return author$project$Util$undefined(_Utils_Tuple0);
	}
};
var author$project$Z3$createUi = function (params) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					['smtlib2', 'datalog']),
				author$project$Z3$formatOfString),
				A2(author$project$Util$createCheckboxLine, author$project$Z3$DisplayGlobalParams, 'display global parameters'),
				A2(author$project$Util$createCheckboxLine, author$project$Z3$DisplayGlobalParamDescs, 'display global parameter descriptions'),
				A2(author$project$Util$createCheckboxLine, author$project$Z3$DisplayStatistics, 'display statistics'),
				A2(author$project$Util$createCheckboxLine, author$project$Z3$DisplayWarnings, 'display warnings')
			]));
};
var elm$virtual_dom$VirtualDom$map = _VirtualDom_map;
var elm$html$Html$map = elm$virtual_dom$VirtualDom$map;
var author$project$Main$createSolverParamsUi = function (params) {
	if (params.$ === 'Z3') {
		var z3params = params.a;
		return A2(
			elm$html$Html$map,
			function (msg) {
				return author$project$Main$Z3Msg(msg);
			},
			author$project$Z3$createUi(z3params));
	} else {
		var cvc4params = params.a;
		return A2(
			elm$html$Html$map,
			function (msg) {
				return author$project$Main$Cvc4Msg(msg);
			},
